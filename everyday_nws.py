...
def img():
    ...
    # 自行调整此处文字所在位置
    draw.text((1500, 55), today, font=font, fill=(255, 255, 0))
...
def post_tg():
    ...
    files = {
        "random-name-1": open(r"d:\Users\samsung\Desktop\各种资料\脚本\爬虫\NEWS\news.jpg", "rb")
        , "random-name-2": open(r"d:\Users\samsung\Desktop\各种资料\脚本\爬虫\NEWS\base.jpg", "rb")
    }
